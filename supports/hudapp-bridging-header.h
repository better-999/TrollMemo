...
static HUDUserDefaultsKey const HUDUserDefaultsKeyTextBold = @"HUDUserDefaultsKeyTextBold";
static HUDUserDefaultsKey const HUDUserDefaultsKeyTextItalic = @"HUDUserDefaultsKeyTextItalic";
static HUDUserDefaultsKey const HUDUserDefaultsKeyTextUnderline = @"HUDUserDefaultsKeyTextUnderline";
